        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="w-full md:w-1/2 lg:w-3/5">
            ...
            <p className="text-white/70 mb-6">
              I'm a passionate web developer with a keen eye for design and a commitment to creating beautiful, functional websites. With over 5 years of experience in the industry, I specialize in building responsive, user-friendly interfaces that drive results.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
              <div className="glass-card p-4 text-center">
                <h3 className="text-purple text-3xl font-bold mb-1">5+</h3>
